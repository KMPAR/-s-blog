...
public class week13_실습1 extends JFrame implements ItemListener {
	...
	private void initPanel1() {
		...
		for(int i =0 ; i<data.length; i++) {
			...
			checkbox[i].addItemListener(this); //현 클래스에 만들었기 때문에 this로 받은 것 !! 내부 클래스로 구현할 경우 내부클래스 이름 넣으면 됨 !
